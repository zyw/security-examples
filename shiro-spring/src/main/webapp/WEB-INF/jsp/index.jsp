...
<html>
    <head>
        ...
        <!-- toastr 2.0.3 -->
        <link href="<c:url value="/r/css/toastr.min.css"/>" rel="stylesheet" type="text/css" />
    ...
    <body class="skin-blue">
            ...
            <aside class="left-side sidebar-offcanvas">                
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <!-- <li class="active">
                            <a href="index.html">
                                <i class="fa fa-dashboard"></i> 组织机构<span></span>
                            </a>
                        </li>
                        <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>用户管理</span> <small class="badge pull-right bg-green">new</small>
                            </a>
                        </li> -->
                        ...
                        <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>其他</span> <small class="badge pull-right bg-green">new</small>
                            </a>
                        </li>
                       <!--  <li class="treeview">
                            <a href="#">
        ...
        <!-- toastr 2.0.3 -->
        <script src='<c:url value="/r/js/toastr.min.js"/>'></script>
        <!-- Bootstrap -->
